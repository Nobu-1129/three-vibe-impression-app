...
1. 控えめ ↔ 目を引く
- 控えめ：主張が強すぎず、落ち着いて受け取れる
- 目を引く：自然に視線が向き、印象に残りやすい

2. ラフ ↔ 整っている
- ラフ：力が抜けていて、気軽さや自然さがある
- 整っている：構図・色・見せ方にまとまりがあり、仕上がり感がある

3. 素直 ↔ 個性的
- 素直：わかりやすく、受け取りやすい
- 個性的：その人らしさや独自の見せ方が感じられる

4. やわらかい ↔ 存在感がある
- やわらかい：穏やかで、安心感や優しさがある
- 存在感がある：画面の中で主役が立っていて、強く印象に残る

5. 静か ↔ にぎやか
- 静か：落ち着きがあり、余韻や静けさを感じる
- にぎやか：動きや明るさがあり、楽しい空気や活気を感じる

6. 親しみやすい ↔ 特別感がある
- 親しみやすい：気軽に見られて、身近に感じやすい
- 特別感がある：日常から少し離れた雰囲気や、印象に残る雰囲気がある

7. 王道 ↔ 独創的
- 王道：定番の良さや、わかりやすい魅力がある
- 独創的：発想や見せ方に独自性があり、他とは違う印象がある

8. インパクト派 ↔ ディテール派
- インパクト派：一目で伝わる強さやわかりやすさがある
...
def plot_16axis_radar_from_8axis(axis_scores: dict):
    ...
    axis_pairs = [
        ...
        ("ラフ ↔ 整っている", "ラフ", "整っている"),
        ("素直 ↔ 個性的", "素直", "個性的"),
        ("やわらかい ↔ 存在感がある", "やわらかい", "存在感がある"),
        ("静か ↔ にぎやか", "静か", "にぎやか"),
        ("親しみやすい ↔ 特別感がある", "親しみやすい", "特別感がある"),
        ("王道 ↔ 独創的", "王道", "独創的"),
